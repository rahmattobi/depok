 <div class="hero-wrap hero-bread" style="background-image: url('<?= base_url('asset/images/')?>bg_6.jpg');">
    ...
    <section class="ftco-section">
      <div class="container">
		...
		<form action="<?php echo site_url('c_pengunjung/uploudbuktipembayaranbooking'); ?>" method="post" enctype="multipart/form-data" class="billing-form">
				<h3 class="mb-4 billing-heading">Detail Pembayaran</h3>
				<?php foreach ($get_detailbooking as $key => $value): ?>
                ...
                <div class="row align-items-end">
	          	   <div class="col-md-6">
	                <div class="form-group">
	                	<label for="firstname">Nama Tempat Kuliner</label>
	                  <input type="text" value="<?php echo $value->nama_kuliner; ?>" class="form-control" placeholder="" disabled>
	                </div>
	              </div>

	              <div class="col-md-6">
	                <div class="form-group">
	                	<label for="lastname">Jumlah Meja yg Dibooking</label>
	                  <input type="text" value="<?php echo $value->jumlah_booking; ?>" class="form-control" placeholder="" disabled>
	                </div>
                  </div>
	          ...
	          <div class="row mt-5 pt-3 d-flex">
	          	<div class="col-md-6 d-flex">
	          	 ...
	          	 ?>
					...
					<input type="hidden" class="form-control" name="id_pestem" required="" value="<?php echo $value->id_pestem;?>">
	          	<?php endforeach ?>
	          	</div>
	          	<div class="col-md-6">
