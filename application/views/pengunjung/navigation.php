...
<body class="goto-here">
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="<?php echo base_url(); ?>c_pengunjung">Depok</a>
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item active"><a href="<?php echo base_url(); ?>c_pengunjung" class="nav-link">Home</a></li>
          <li class="nav-item"><a href="<?php echo base_url(); ?>c_login" class="nav-link">Login</a></li>
          <li class="nav-item cta cta-colored"><a href="<?php echo base_url(); ?>c_pengunjung/cart" class="nav-link"><span class="icon-shopping_cart"></span>[0]</a></li>
