					...
					<div class="row">
						<div class="col-md-12 d-flex ftco-animate">
							<div class="blog-entry align-self-stretch d-md-flex">
								<a href="<?php echo base_url() ?>c_pengunjung/detail_wisataa/<?php echo $value->id_wisata ?>" class="block-20" style="background-image: url('<?= base_url('images/')?><?php echo $value->foto; ?>');">
								</a>
								<div class="text d-block pl-md-4">
									...
									<h3 class="heading"><a href="<?php echo base_url() ?>c_pengunjung/detail_wisataa/<?php echo $value->id_wisata ?>"><?php echo strtoupper($value->nama_wisata); ?></a></h3>
									<p><?php echo $value->desc; ?></p>
									<p><a href="<?php echo base_url('c_pengunjung/detail_wisataa/') ?><?php echo $value->id_wisata ?>" class="btn btn-primary py-2 px-3">Detail Wisata</a></p>
								</div>
							</div>
						</div>
					</div>
