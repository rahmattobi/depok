            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class='breadcrumb-header'>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>c_admin/profile">Profile</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    <form action="<?php echo site_url('c_admin/edit_profile/'); ?><?php echo $get_userprofile->id_user ?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                    ...
                    <br>
                        <div>
                            ...
                            <a href="<?php echo base_url(); ?>c_admin/profile">
